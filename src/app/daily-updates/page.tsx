      ...
      <div className="p-6">
        <div className="mb-6">
            ...
            <div>
              ...
              <p className="text-gray-600">Track and manage daily progress updates from your gas operations team</p>
            </div>
              </div>
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-gradient-to-r from-amber-500 to-orange-500 text-white rounded-lg hover:from-amber-600 hover:to-orange-600 transition-all duration-200 font-medium shadow-md hover:shadow-lg flex items-center gap-2"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  updates.map((update) => {
                    ...
                    return (
                      <tr key={update.id} className={`hover:bg-gray-50 ${isSelected ? 'bg-amber-50' : ''}`}>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{update.date}</td>
