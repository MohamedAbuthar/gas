    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8 text-center">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Gas Company Management System</h1>
          <p className="text-lg text-gray-600">Efficiently manage your gas operations, team members, and daily updates</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div 
            ...
            className="bg-white rounded-2xl shadow-xl border border-gray-200 p-8 cursor-pointer hover:shadow-2xl transition-all duration-300 hover:scale-105 group"
          >
            <div className="flex items-center justify-between mb-4">
              <div className="w-12 h-12 bg-gradient-to-r from-amber-100 to-orange-100 rounded-xl flex items-center justify-center group-hover:from-amber-200 group-hover:to-orange-200 transition-colors">
            ...
            <p className="text-gray-600 mb-4">Track daily progress and updates from your gas operations team</p>
          ...
          >
            <div className="flex items-center justify-between mb-4">
              <div className="w-12 h-12 bg-gradient-to-r from-blue-100 to-indigo-100 rounded-xl flex items-center justify-center group-hover:from-blue-200 group-hover:to-indigo-200 transition-colors">
            ...
            <p className="text-gray-600 mb-4">Track daily attendance and working hours of delivery personnel</p>
          ...
          >
            <div className="flex items-center justify-between mb-4">
              <div className="w-12 h-12 bg-gradient-to-r from-orange-100 to-red-100 rounded-xl flex items-center justify-center group-hover:from-orange-200 group-hover:to-red-200 transition-colors">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Member Details</h3>
            <p className="text-gray-600 mb-4">View and manage all gas operations team member information</p>
          ...
          >
            <div className="flex items-center justify-between mb-4">
              <div className="w-12 h-12 bg-gradient-to-r from-green-100 to-emerald-100 rounded-xl flex items-center justify-center group-hover:from-green-200 group-hover:to-emerald-200 transition-colors">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Add Roles & Members</h3>
            <p className="text-gray-600 mb-4">Create new roles and add team members to your gas operations</p>
